...
def main():
    ...
    ilist = ['Rachas.csv']
    tlist = ['MESES CONSECUTIVOS CON SEQUIA METEOROLOGICA']
...
#    plt.title("Mapa de "+tlist+" correspondiente al mes de \n"+mes, fontsize=14, fontweight='bold')
    ...
    colors = ('#ffffff','#ffff77','#eac400','#f59700','#a87000','#573b04')
    clevs= [0.,1.,2.,4.,8,11,12]
...
#    cb = mpl.colorbar.ColorbarBase(ax2, cmap=cmap1, spacing='uniform', ticks=clevs, boundaries=clevs, format='%2.1f')
    ...
    ax2 = fig.add_axes([0.17, 0.33, 0.25, 0.05])
...
#    cb.set_ticklabels(['0','1','2','4','8','11','>12'], update_ticks=True)
#    cb.set_label('Numero de meses', rotation=270, labelpad=20)
    ...
    plt.text(0.22, 0.299,"   0             1          2-3        4-7        8-11      >=12", ha='center', va='center', fontsize=11, transform=ax.transAxes)

    plt.text(0.22, 0.18,"NUMERO DE MESES CONSECUTIVOS CON SEQUIA METEOROLOGICA", ha='center', va='center', fontsize=10, transform=ax.transAxes)
